...
export default function InterventionPage() {
  ...
  return (
    <motion.div
      className="mx-auto max-w-md md:max-w-none md:w-full md:mx-0 p-4 md:p-8 pb-24 space-y-6 bg-gradient-to-br from-orange-50 to-amber-50 min-h-screen relative"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
